...
\end{verbatim}
%
\index{$"!=$ numeric inequality operator}
\index{$<$ less than numeric operator}
\index{$>$ greater than numeric operator}
\index{$>=$ greater than or equal operator}
\index{operator!$"!=$ (numeric inequality)}
\index{operator!$<$ (numerically less than)}
\index{operator!$>$ (numerically greater than)}
\index{$<=$ less than or equal operator}
\index{operator!$>=$ (greater than or equal)}
\index{operator!$<=$ (less than or equal)}
...
\index{$===$ value identity operator}
\index{operator!$===$ (value identity)}
\index{equality operator}
\index{operator!equal}
\index{operator!relational}
\index{$=>$ pair constructor}
\index{operator!$=>$ (pair constructor)}
\index{pair constructor}
\index{constructor!pair}

The difference between {\tt ==} and {\tt ===} is that the former operator checks whether the values of the operands are equal and the latter checks whether the operands are truly identical. As an example, consider this:
...
For example, 1110 if greater than 886. 
...
The {\tt unless} conditional is most commonly used in its statement modifier form:
\index{statement modifier}
...
having a \verb'MAIN' defined will usually start its execution 
