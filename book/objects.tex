...
\index{type object}
Defining a class named {\tt Point} creates a {\bf type object}.
...
but we will stay with {\tt new} for the time being.
...
as {\tt MovablePoint} subclasses {\tt Point2D}, the program 
...
Let's come back to vertebrate, mammals and dogs. A dog is 
...
{\tt Rectangle} class; without this ref=definition, it would 
have raised a compile-time error. Similarly, the \verb'method area { ... }' 
...
(see \ref{sol_rotate}, p.~\pageref{sol_rotate}) for the 
