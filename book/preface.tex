...
the first (or one of the first) published books using Perl~6, 
...
things that are not covered elsewhere in the book. So, 
...
In late 2015, I was feeling that a Perl~6 document for beginners 
...
I take all responsibility. Any error is my fault, 
not Allen's.
