...
first published book using Perl~6, 
...
into French Allen B. Downey's \emph{Think Python, second edition} 
...
an interview with \emph{LinuxVoice} (July 2015), Larry Wall, the 
creator of Perl~6, said: 
